...
--
myLayout = smartBorders $ mkToggle (NOBORDERS ?? FULL ?? EOT) $ tiled ||| Mirror tiled ||| Full
  where
    -- default tiling algorithm partitions the screen into two panes
    tiled   = spacing 6 $ smartBorders $Tall nmaster delta ratio
...
myManageHook = composeAll
    ...
    , className =? "League of Legends" --> doFloat
